...
export class AboutComponent {
  ...
  languages = [
    { name: 'English', level: 'C2', color: 'linear-gradient(135deg, #007bff, #00c6ff)' },
    { name: 'French', level: 'C1', color: 'linear-gradient(135deg, #ff8a00, #e52e71)' },
    { name: 'Italian', level: 'B2', color: 'linear-gradient(135deg, #28a745, #8fd3f4)' },
    { name: 'Arabic', level: 'C2', color: 'linear-gradient(135deg, #ffc107, #ffeb3b)' }
  ];
